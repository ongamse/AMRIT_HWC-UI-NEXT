...
@NgModule({
  ...
  declarations: [
    ...
    // DiagnosisSearchComponent, ConfirmatoryDiagnosisDirective, ShowCommitAndVersionDetailsComponent
    // , IotcomponentComponent, IotBluetoothComponent,AllergenSearchComponent,CalibrationComponent,
    // SetLanguageComponent,HealthIdDisplayModalComponent, ClinicalObservationsDirective, SignificantFindingsDirective,
    // myHealthId, OpenPreviousVisitDetailsComponent
  ],
  exports: [
    MaterialModule,
    CommonDialogComponent,
    ...
    // IotcomponentComponent, IotBluetoothComponent,AllergenSearchComponent,CalibrationComponent,
    // SetLanguageComponent,HealthIdDisplayModalComponent, ClinicalObservationsDirective, SignificantFindingsDirective, OpenPreviousVisitDetailsComponent
  ],
//   entryComponents: [
//     CommonDialogComponent,
//     CameraDialogComponent,
